...
const configurationProvider = new (require("./ConfigurationProvider"))("../resources/classification-model.json");
...
describe("#processJob", () => {
    ...
    it("should type all pages correctly", async () => {
        ...
        expect(postStub.args[0][0]).to.eql(`http://classification-storage-api:52629/sites/site01/pages/${encodedPageUrl}`);
