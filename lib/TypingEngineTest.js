...
describe("#getEffectiveSelector", () => {
    ...
    it("should throw if no selector was specified", () => {
        ...
        expect(() => {
            typingEngine.getEffectiveSelector(property, configuration.contentTypes);
        }).to.throw();
    });
    ...
    it("should fallback to the selector specified by the type", () => {
        ...
        const effectiveSelector = typingEngine.getEffectiveSelector(property, configuration.contentTypes);
    ...
    it("should prefer the selector specified by the property", () => {
        const typingEngine = new TypingEngine(null, configurationProvider);
        const property = { "selector": { "type": "CssSelector", "value": "div > span" }, "type": "PageHeading" };
        const effectiveSelector = typingEngine.getEffectiveSelector(property, configuration.contentTypes);
